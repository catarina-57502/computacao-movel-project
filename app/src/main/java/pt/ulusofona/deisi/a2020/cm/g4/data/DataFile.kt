...
class DataFile {
    ...
    constructor(data: String, obitos: Int, recuperados: Int, internados: Int, internados_uci: Int, confirmados_arsnorte: Int, confirmados_arscentro: Int, confirmados_arslvt: Int, confirmados_arsalentejo: Int, confirmados_arsalgarve: Int, confirmados_acores: Int, confirmados_madeira: Int) {
        this.data = data
        this.obitos = obitos
