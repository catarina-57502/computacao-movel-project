...
class DataSource{
    ...
    var list_datas = mutableListOf<DataFile>(DataFile("1-04-2021", 824368, 16887, 781537, 504, 113, 331422, 117460, 312537, 29229, 20880, 4125, 8715),
            DataFile("2-04-2021", 825031, 16890, 782294, 488, 116, 331604, 117531, 312799, 29261, 20926, 4167, 8743))
